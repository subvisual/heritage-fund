class PaExpressionOfInterest < ApplicationRecord
  ...
  attr_accessor :validate_feasibility_or_options_work
  ...
  validates :feasibility_or_options_work, presence: true, if: :validate_feasibility_or_options_work?
  ...
  def validate_feasibility_or_options_work?
    validate_feasibility_or_options_work == true
  end
