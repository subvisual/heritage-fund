class Project < ApplicationRecord
  ...
  attr_accessor :validate_title, :validate_start_and_end_dates, :validate_same_location, :validate_capital_work, :validate_permission_type, :validate_permission_description_yes, :validate_permission_description_x_not_sure, :validate_description, :validate_difference, :validate_matter, :validate_heritage_description, :validate_best_placed_description, :validate_involvement_description, :validate_other_outcomes, :validate_project_costs, :validate_has_associated_project_costs, :validate_cash_contributions, :validate_non_cash_contributions, :validate_evidence_of_support, :validate_volunteers, :validate_cash_contributions_question, :validate_non_cash_contributions_question, :validate_check_your_answers, :validate_governing_document_file, :validate_accounts_files, :validate_confirm_declaration, :validate_is_partnership, :validate_partnership_details, :start_date_month, :start_date_year, :end_date_day, :end_date_month, :end_date_year, :cash_contributions_question, :non_cash_contributions_question, :same_location, :permission_description_yes, :permission_description_x_not_sure, :confirm_declaration
  ...
  def to_salesforce_json
    setAddressLines = lambda { |line1, line2, line3|
    ...
    Jbuilder.encode do |json|
      ...
      json.application do
        ...
        json.mainContactAddress do
          json.line1 setAddressLines.call(user.line1, user.line2, user.line3)
        ...
        json.organisationAddress do
          json.line1 setAddressLines.call(user.organisations.first.line1, user.organisations.first.line2, user.organisations.first.line3)
        ...
        set_legal_signatory_fields = lambda { |ls|
