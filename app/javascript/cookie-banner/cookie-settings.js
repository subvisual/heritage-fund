...
CookieSettings.prototype.submitSettingsForm = function (event) {
    ...
    if (options.analytics && !window.NLHFGOVUKFrontend.analytics) {
        InitialiseAnalytics()
    }
...
CookieSettings.prototype.showConfirmationMessage = function () {
    var confirmationMessage = document.querySelector('#nlhf-cookie-settings-confirmation')
    var previousPageLink = document.querySelector('.nlhf-cookie-settings__prev-page')
...
CookieSettings.prototype.showErrorMessage = function () {
    const errorMessages = document.querySelectorAll('.nlhf-cookie-settings__error')
    const formGroup = document.getElementById('nlhf-cookie-settings-form-group')
...
CookieSettings.prototype.hideErrorMessage = function () {
    var errorMessage = document.querySelector('#nlhf-cookie-settings-error')
...
CookieSettings.prototype.hideWarningMessage = function () {
    var warningMessage = document.querySelector('#nlhf-cookie-settings-warning')
...
CookieSettings.prototype.hideCookieBanner = function () {
    var cookieBanner = document.querySelector('.nlhf-cookie-banner')
