  ...
  def show
	...
	def update
		...
		if @funding_application.valid?
			...
			agreed_to_terms = has_agreed_to_terms(@funding_application.declarations.first)
			expressed_confirmation = has_expressed_confirmation(@funding_application.declarations.fifth)
    ...
    unless params[:funding_application].present?
      params.merge!({"funding_application": {"declarations_attributes"=>{}}})
		end
	...
	def build_agreed_to_terms(request_params)
		...
		question_response = request_params && request_params.dig(:funding_application, :declarations_attributes, :"0", :agreed_to_terms)
		@funding_application.declarations.first.json = { text: I18n.t("hef_loan_declarations_form.text.agreed_to_terms"),
			question: I18n.t("hef_loan_declarations_form.questions.agreed_to_terms"), 
				question_response: question_response }
	end


	def has_agreed_to_terms(agreed_to_terms_declaration)
		...
		unless agreed_to_terms_declaration.json.present? && agreed_to_terms_declaration.json["question_response"].present? 		
			agreed_to_terms_declaration.errors[:agreed_to_terms] << I18n.t("hef_loan_declarations_form.errors.agreed_to_terms")
			return false
		end
		return true
	end

	def has_expressed_confirmation(confirmation_declaration)
		# specific error checking for this instance of declaration.  Which is why the checking is here - not in the model.  
	...
	def build_data_and_foi(request_params)
		...
		applicants_response = request_params && request_params.dig(:funding_application, :declarations_attributes, :"1", :applicants_response)
		@funding_application.declarations.second.applicants_response = applicants_response

		@funding_application.declarations.second.json = { text: I18n.t("hef_loan_declarations_form.text.data_and_foi"),
	...
	def build_data_protection_and_research(request_params)
		...
		question_response = request_params && request_params.dig(:funding_application, :declarations_attributes, :"2", :data_protection_and_research)
		@funding_application.declarations.third.json = { text: I18n.t("hef_loan_declarations_form.text.data_protection_and_research"),
	...
	def build_contact(request_params)
		...
		question_response = request_params && request_params.dig(:funding_application, :declarations_attributes, :"3", :contact)
		@funding_application.declarations.fourth.json = { text: I18n.t("hef_loan_declarations_form.text.contact"), \
	...
	def build_confirmation(request_params)
		...
		question_response = request_params && request_params.dig(:funding_application, :declarations_attributes, :"4", :confirmation)
		@funding_application.declarations.fifth.json = { text: I18n.t("hef_loan_declarations_form.text.confirmation"), 
	...
	def build_form_feedback(request_params)
		...
		applicants_response = request_params && request_params.dig(:funding_application, :declarations_attributes, :"5", :applicants_response)
		# applicants_response is an attr_accessor
		@funding_application.declarations[5].applicants_response = applicants_response
		@funding_application.declarations[5].json = { text: I18n.t("hef_loan_declarations_form.text.form_feedback"), 
