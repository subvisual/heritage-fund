class FundingApplication::HefLoan::FormController < ApplicationController
    ...
    def construct_people()
        ...
        @funding_application.people.build unless
            @funding_application.people.first.present?

        @funding_application.people.build unless
            @funding_application.people.second.present?
    ...
    def build_organisations_org_types()
        ...
        ) unless @funding_application.organisation.organisations_org_types.where(org_type_id: @org_type_registered_charity.id).present? || 
            @funding_application.organisation.organisations_org_types.select { |ot| ot.org_type_id == @org_type_registered_charity.id}.present?

        @funding_application.organisation.organisations_org_types.build(
            org_type_id: @org_type_registered_company.id
        ) unless @funding_application.organisation.organisations_org_types.where(org_type_id: @org_type_registered_company.id).present? || 
            @funding_application.organisation.organisations_org_types.select { |ot| ot.org_type_id == @org_type_registered_company.id}.present?

        @funding_application.organisation.organisations_org_types.build(
            org_type_id: @org_type_community_interest_company.id
        ) unless @funding_application.organisation.organisations_org_types.where(org_type_id: @org_type_community_interest_company.id).present? || 
            @funding_application.organisation.organisations_org_types.select { |ot| ot.org_type_id == @org_type_community_interest_company.id}.present?

        @funding_application.organisation.organisations_org_types.build(
            org_type_id: @org_type_faith_based_organisation.id
        ) unless @funding_application.organisation.organisations_org_types.where(org_type_id: @org_type_faith_based_organisation.id).present? || 
            @funding_application.organisation.organisations_org_types.select { |ot| ot.org_type_id == @org_type_faith_based_organisation.id}.present?

        @funding_application.organisation.organisations_org_types.build(
            org_type_id: @org_type_church_organisation.id
        ) unless @funding_application.organisation.organisations_org_types.where(org_type_id: @org_type_church_organisation.id).present? || 
            @funding_application.organisation.organisations_org_types.select { |ot| ot.org_type_id == @org_type_church_organisation.id}.present?

        @funding_application.organisation.organisations_org_types.build(
            org_type_id: @org_type_community_group.id
        ) unless @funding_application.organisation.organisations_org_types.where(org_type_id: @org_type_community_group.id).present? || 
            @funding_application.organisation.organisations_org_types.select { |ot| ot.org_type_id == @org_type_community_group.id}.present?

        @funding_application.organisation.organisations_org_types.build(
            org_type_id: @org_type_voluntary_group.id
        ) unless @funding_application.organisation.organisations_org_types.where(org_type_id: @org_type_voluntary_group.id).present? || 
            @funding_application.organisation.organisations_org_types.select { |ot| ot.org_type_id == @org_type_voluntary_group.id}.present?

        @funding_application.organisation.organisations_org_types.build(
            org_type_id: @org_type_individual_private_owner_of_heritage.id
        ) unless @funding_application.organisation.organisations_org_types.where(org_type_id: @org_type_individual_private_owner_of_heritage.id).present? || 
            @funding_application.organisation.organisations_org_types.select { |ot| ot.org_type_id == @org_type_individual_private_owner_of_heritage.id}.present?
    ...
    def build_gp_hef_loans_plans_for_loans()
        ...
        ) unless @funding_application.gp_hef_loan.gp_hef_loans_plans_for_loans.where(plans_for_loan_id: @plans_for_loan_cashflow.id).present? || 
            @funding_application.gp_hef_loan.gp_hef_loans_plans_for_loans.select { |p| p.plans_for_loan_id == @plans_for_loan_cashflow.id}.present?

        @funding_application.gp_hef_loan.gp_hef_loans_plans_for_loans.build(
            plans_for_loan_id: @plans_for_loan_staff_salaries.id
        ) unless @funding_application.gp_hef_loan.gp_hef_loans_plans_for_loans.where(plans_for_loan_id: @plans_for_loan_staff_salaries.id).present? || 
            @funding_application.gp_hef_loan.gp_hef_loans_plans_for_loans.select { |p| p.plans_for_loan_id == @plans_for_loan_staff_salaries.id}.present?

        @funding_application.gp_hef_loan.gp_hef_loans_plans_for_loans.build(
            plans_for_loan_id: @plans_for_loan_working_capital.id
        ) unless @funding_application.gp_hef_loan.gp_hef_loans_plans_for_loans.where(plans_for_loan_id: @plans_for_loan_working_capital.id).present? || 
            @funding_application.gp_hef_loan.gp_hef_loans_plans_for_loans.select { |p| p.plans_for_loan_id == @plans_for_loan_working_capital.id}.present?

        @funding_application.gp_hef_loan.gp_hef_loans_plans_for_loans.build(
            plans_for_loan_id: @plans_for_loan_recovering_planning.id
        ) unless @funding_application.gp_hef_loan.gp_hef_loans_plans_for_loans.where(plans_for_loan_id: @plans_for_loan_recovering_planning.id).present? || 
            @funding_application.gp_hef_loan.gp_hef_loans_plans_for_loans.select { |p| p.plans_for_loan_id == @plans_for_loan_recovering_planning.id}.present?
    ...
    def build_gp_hef_loans_repayment_freqs()
        ...
        ) unless @funding_application.gp_hef_loan.gp_hef_loans_repayment_freqs.where(repayment_frequency_id: @repayment_frequency_monthly.id).present? || 
            @funding_application.gp_hef_loan.gp_hef_loans_repayment_freqs.select { |rf| rf.repayment_frequency_id == @repayment_frequency_monthly.id}.present?

        @funding_application.gp_hef_loan.gp_hef_loans_repayment_freqs.build(
            repayment_frequency_id: @repayment_frequency_quarterly.id
        ) unless @funding_application.gp_hef_loan.gp_hef_loans_repayment_freqs.where(repayment_frequency_id: @repayment_frequency_quarterly.id).present? || 
            @funding_application.gp_hef_loan.gp_hef_loans_repayment_freqs.select { |rf| rf.repayment_frequency_id == @repayment_frequency_quarterly.id}.present?

        @funding_application.gp_hef_loan.gp_hef_loans_repayment_freqs.build(
            repayment_frequency_id: @repayment_frequency_yearly.id
        ) unless @funding_application.gp_hef_loan.gp_hef_loans_repayment_freqs.where(repayment_frequency_id: @repayment_frequency_yearly.id).present? || 
            @funding_application.gp_hef_loan.gp_hef_loans_repayment_freqs.select { |rf| rf.repayment_frequency_id == @repayment_frequency_yearly.id}.present?
    ...
    def build_gp_hef_loans_org_income_types()
        ...
        ) unless @funding_application.gp_hef_loan.gp_hef_loans_org_income_types.where(org_income_type_id: @org_income_type_government_contract.id).present? || 
            @funding_application.gp_hef_loan.gp_hef_loans_org_income_types.select { |oit| oit.org_income_type_id == @org_income_type_government_contract.id}.present?

        @funding_application.gp_hef_loan.gp_hef_loans_org_income_types.build(
            org_income_type_id: @org_income_type_rental_income.id
        ) unless @funding_application.gp_hef_loan.gp_hef_loans_org_income_types.where(org_income_type_id: @org_income_type_rental_income.id).present? || 
            @funding_application.gp_hef_loan.gp_hef_loans_org_income_types.select { |oit| oit.org_income_type_id == @org_income_type_rental_income.id}.present?

        @funding_application.gp_hef_loan.gp_hef_loans_org_income_types.build(
            org_income_type_id: @org_income_type_membership_fees.id
        ) unless @funding_application.gp_hef_loan.gp_hef_loans_org_income_types.where(org_income_type_id: @org_income_type_membership_fees.id).present? || 
            @funding_application.gp_hef_loan.gp_hef_loans_org_income_types.select { |oit| oit.org_income_type_id == @org_income_type_membership_fees.id}.present?

        @funding_application.gp_hef_loan.gp_hef_loans_org_income_types.build(
            org_income_type_id: @org_income_type_grants.id
        ) unless @funding_application.gp_hef_loan.gp_hef_loans_org_income_types.where(org_income_type_id: @org_income_type_grants.id).present? || 
            @funding_application.gp_hef_loan.gp_hef_loans_org_income_types.select { |oit| oit.org_income_type_id == @org_income_type_grants.id}.present?

        @funding_application.gp_hef_loan.gp_hef_loans_org_income_types.build(
            org_income_type_id: @org_income_type_donations.id
        ) unless @funding_application.gp_hef_loan.gp_hef_loans_org_income_types.where(org_income_type_id: @org_income_type_donations.id).present? || 
            @funding_application.gp_hef_loan.gp_hef_loans_org_income_types.select { |oit| oit.org_income_type_id == @org_income_type_donations.id}.present?

        @funding_application.gp_hef_loan.gp_hef_loans_org_income_types.build(
            org_income_type_id: @org_income_type_trading.id
        ) unless @funding_application.gp_hef_loan.gp_hef_loans_org_income_types.where(org_income_type_id: @org_income_type_trading.id).present? || 
            @funding_application.gp_hef_loan.gp_hef_loans_org_income_types.select { |oit| oit.org_income_type_id == @org_income_type_trading.id}.present?
    ...
    def funding_application_params
        ...
        if params.dig(:funding_application, :organisation_attributes, :organisations_org_types_attributes)
            params.dig(:funding_application, :organisation_attributes, :organisations_org_types_attributes).each do |org_type|
        ...
        if params.dig(:funding_application, :gp_hef_loan_attributes, :gp_hef_loans_org_income_types_attributes)
            params.dig(:funding_application, :gp_hef_loan_attributes, :gp_hef_loans_org_income_types_attributes).each do |org_income_type|
        ...
        if params.dig(:funding_application, :gp_hef_loan_attributes, :gp_hef_loans_repayment_freqs_attributes)
            params.dig(:funding_application, :gp_hef_loan_attributes, :gp_hef_loans_repayment_freqs_attributes).each do |repayment_frequency|
        ...
        if params.dig(:funding_application, :gp_hef_loan_attributes, :gp_hef_loans_plans_for_loans_attributes)
            params.dig(:funding_application, :gp_hef_loan_attributes, :gp_hef_loans_plans_for_loans_attributes).each do |plan_for_loan|
